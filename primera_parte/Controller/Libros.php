<?php
    class Libros extends Controllers{
        ...
        public function libros()
        {
            ...
            $data = ['libros' => $libro, 'materias' => $materias, 'autores' => $autor];
        ...
        public function registrar()
        {
            ...
            if ($imgName == null || $imgName == "") {
                $insert = $this->model->insertarLibro($titulo, $cantidad, $Numero_serie, $autor, $materia,  $descripcion, "default-avatar.png");
            }else{
                $insert = $this->model->insertarLibro($titulo, $cantidad, $Numero_serie, $autor, $editorial, $anio_edicion, $materia, $num_pagina, $descripcion, $fecha);
                if ($insert) {
        ...
        public function modificar()
        {
            ...
            if ($imgName == null || $imgName == "") {
                $actualizar = $this->model->actualizarLibro($titulo, $cantidad, $Numero_serie, $autor , $materia, $descripcion, $imgAntigua, $id);
            } else {
                $actualizar = $this->model->actualizarLibro($titulo, $cantidad, $Numero_serie, $autor, $editorial, $anio_edicion, $materia, $num_pagina, $descripcion, $fecha, $id);
                if ($actualizar) {
                    move_uploaded_file($nombreTemp, $destino);
