    ...
    <?php if (isset($_GET['no_s'])) { ?>
        <div class="toast ml-auto mr-1 bg-danger text-white" id="alerta" role="alert" data-delay="3000" aria-live="assertive" aria-atomic="true">
            ...
            <div class="toast-body">
                No hay cañon disponible intentelo en otro momento
            </div>
        </div>
    <?php } ?>
    <main>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="my-modal-title">Prestar Cañon</h5>
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?php echo base_url(); ?>admin/registrar">
                            <div class="form-group">
                                <label for="buscar_libro">cañon</label><br>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <label for="estudiante">Maestro</label><br>
