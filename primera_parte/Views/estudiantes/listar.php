...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h5 class="text-center">Maestros</h5>
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $estudiante['Numero_empleado']; ?></td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="Numero_empleado" class="form-control" type="text" name="Numero_empleado" required placeholder="Número de empleado">
                                </div>
                            </div>
